...
var $addList = $itemList.find('li.add');
var urlData = localStorage.getItem('urlData');
var dataObj = JSON.parse(urlData); //把string变成对象
...
var simplifyUrl = function simplifyUrl(url) {
  return url.replace('http://', '').replace('https://', '').replace('www.', '').replace(/\/.*/, ''); //删除以'/'开头的url
};
...
$('.addItem').on('click', function () {
  var url = window.prompt('请添加你输入的地址');
